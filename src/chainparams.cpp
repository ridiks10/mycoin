...
{
    const char* pszTimestamp = "Times Sun, 05 Feb 2017 20:00:00 GMT";
    const CScript genesisOutputScript = CScript() << ParseHex("04b1cafbe6965285621b52592ba34035e14c27ea84ef6d31af71b3934bd6a556536b3b942ed3c9b31c3a2201557326ece31356067e1bab9889328fad929a4bb6b0") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1486324800, 2344730, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x9b600410d43a929c0ad64c3216cebb08c1e8e126ccb4676c7b262972f6087d57"));
       ...
       vSeeds.clear();      //!< Regtest mode doesn't have any DNS seeds.
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
                (0, uint256S("0x9b600410d43a929c0ad64c3216cebb08c1e8e126ccb4676c7b262972f6087d57"))
                (4, uint256S("0xa96d1847db70cfad98dedd55b89593b714253c3170aaa4a7954fbf416c689bfd")),
                1486425891, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486324801, 5541835, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc765dacc929ffb27e97560c5be51c8e1ef50af1f5658375166196c72ad8c1d91"));
        assert(genesis.hashMerkleRoot == uint256S("0x0f90ba3d18b78862f4aa884701e1e57739a9af403c3ba32671cf811da78ebcd9"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
                (0, uint256S("0xc765dacc929ffb27e97560c5be51c8e1ef50af1f5658375166196c72ad8c1d91")),
                1486324801,
                0,
                576
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1486324802, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x025b98e564dc7f9aaebb9cacfb0b4ab7c582833789e0fa0c3ecd5265b418eb4f"));
        assert(genesis.hashMerkleRoot == uint256S("0x0f90ba3d18b78862f4aa884701e1e57739a9af403c3ba32671cf811da78ebcd9"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
                (0, uint256S("0x025b98e564dc7f9aaebb9cacfb0b4ab7c582833789e0fa0c3ecd5265b418eb4f")),
                0,
                0,
                0
        };
